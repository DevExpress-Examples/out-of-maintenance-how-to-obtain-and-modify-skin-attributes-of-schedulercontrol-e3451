...
Namespace SchedulerSkinAttributes
	Partial Public Class SkinCustomizationForm
		...
		Private Sub InitializeComponent()
			...
			CType(Me.pbSkinElementImage, System.ComponentModel.ISupportInitialize).BeginInit()
			Me.SuspendLayout()
			' 
			' lbSkinElements
			' 
...
'			Me.lbSkinElements.SelectedIndexChanged += New System.EventHandler(Me.selectionUI_SelectedIndexChanged);
			' 
			' label1
			' 
...
'			Me.pgSkinElementItem.PropertyValueChanged += New System.Windows.Forms.PropertyValueChangedEventHandler(Me.pgSkinElementItem_PropertyValueChanged);
			' 
			' label2
			' 
...
'			Me.cbElementAttributes.SelectedIndexChanged += New System.EventHandler(Me.selectionUI_SelectedIndexChanged);
			' 
			' label3
			' 
...
'			Me.btnClearImage.Click += New System.EventHandler(Me.btnClearImage_Click);
			' 
			' btnOk
			' 
...
'			Me.btnOk.Click += New System.EventHandler(Me.btnOk_Click);
			...
			CType(Me.pbSkinElementImage, System.ComponentModel.ISupportInitialize).EndInit()
